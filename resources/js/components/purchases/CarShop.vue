    ...
    <div>
        <div class="d-flex justify-content-end">
            ...
            <v-modal idmodal="modal-sales-add-product">
                <span slot="header">Agregar productos a la compra</span>
                <div slot="body">
        ...
        changeQuantityToProduct(action, product, key) {
            ...
            this.products = this.products.filter((x,index) => {
                ...
                if(x.id === product.id) {
                  ...
                  product.total = ( parseFloat(product.price_purchase) * product.quantity_stock ); // precio total
                }
